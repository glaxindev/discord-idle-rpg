...
module.exports = (client) => {
    for (const type of readdirSync(`${process.cwd()}/src/commands/`)) {
        for (const dir of readdirSync(`${process.cwd()}/src/commands/` + type)) {
            for (const file of readdirSync(`${process.cwd()}/src/commands/` + type + '/' + dir).filter((f) => f.endsWith('.js'))) {
